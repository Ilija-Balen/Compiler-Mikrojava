...
public class IdentExprSQBraceIdent extends IdentExprList {

    private IdentExprList IdentExprList;
    private Expr Expr;

    public IdentExprSQBraceIdent (IdentExprList IdentExprList, Expr Expr) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("IdentExprSQBraceIdent(\n");
