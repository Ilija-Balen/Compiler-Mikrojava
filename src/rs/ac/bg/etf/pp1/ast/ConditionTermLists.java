...
public class ConditionTermLists extends CondTermList {

    private CondTermList CondTermList;
    private CondTerm CondTerm;

    public ConditionTermLists (CondTermList CondTermList, CondTerm CondTerm) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ConditionTermLists(\n");
